...
(function () {
  ...
  var h = el('h1');
  h.appendChild(document.createTextNode('Do you clear the '));
  h.appendChild(el('em', null, 'rules'));
  ...
  function showResults(a) {
    ...
    if (eligible.length) {
      var t1 = el('div', 'table reveal');
      eligible.forEach(function (r) { t1.appendChild(schoolRow(r)); });
